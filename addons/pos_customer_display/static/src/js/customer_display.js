...
openerp.pos_customer_display = function(instance){
    ...
    module.PosModel = module.PosModel.extend({
        ...
        //alert('Type: ' + type);
            ...
            if (type == 'addProduct'){
                ...
                //alert('line: ' + line);
                //alert('price_of_unit: ' + price_unit);
            ...
            this.proxy.connect('http://localhost:8069');
    ...
    module.ProxyDevice = module.ProxyDevice.extend({
        ...
        send_text_customer_display: function(data, line_length, text_mode){
...
//              alert(JSON.stringify(data));
                return this.message('send_text_customer_display', {'text_to_display' : JSON.stringify(data), 'text_mode' : text_mode});
            }
        },
